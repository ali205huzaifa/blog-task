...
export function OTPSignUpContainer({
  redirectUrl,
  ...
  const onEmailSubmit = useCallback(
    async ({ email }: { email: string }) => {
      if (displayTermsCheckbox && !agreedToTerms) {
        ...
        >
          <div>
            ...
            <p className="mb-6 text-sm text-gray-600">
              Enter your email address to sign up securely without a password
            </p>
          </div>
  ...
  return (
    <Form {...otpForm}>
      ...
      >
        <div>
          <h3 className="mb-4 font-semibold">Verify Your Email</h3>
          <p className="mb-6 text-sm text-gray-600">
